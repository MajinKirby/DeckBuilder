...
<br>
<br>
<form action="all_traps.php" method="GET">
...
if (isset($_GET['search_term'])) {
  ...
  $query = "SELECT * FROM Trap_Cards WHERE Name LIKE '%$search_term%'";
} else {
  // Default query to select all rows
  $query = "SELECT * FROM Trap_Cards";
}
...
echo "<h1>Number of Trap cards found: " . $num_results . "</h1>";

// Output table header
echo "<table border='1'>";
echo "<tr><th>Name</th><th>Trap_Type</th><th>Effect</th></tr>";
...
for ($i = 0; $i < $num_results; $i++) {
  ...
  echo "<td>" . htmlspecialchars($row["Trap_Type"]) . "</td>";
